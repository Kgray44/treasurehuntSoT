...
Project Homeport Phase 1 makes the Passport and product shell read the
...
the prior state and allows retry. This behavior is on main; its retained
evidence is synthetic and does not establish deployment or owner acceptance.
