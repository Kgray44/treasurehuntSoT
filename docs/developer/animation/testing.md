...
audience: developer
status: current
canonical_for: animation-testing
last_reviewed: 2026-08-05
---

# Animation testing

Test lifecycle ownership, reduced-motion and keyboard behavior, route transitions, visual regressions, and performance in isolated browser runs. Validate that inactive hosts are inert and no duplicate live scene identity is created.
