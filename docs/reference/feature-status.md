...
| Homeport Phase 7, Drydock, Landfall, and Watchglass | planned                | not validated         | Integrated Homeport journeys, the owner package, and the remaining planned projects have no current product availability claim.                                                   |
