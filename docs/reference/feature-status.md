...
| Sounding Line, Homeport Phases 6-7, Drydock, Landfall, and Watchglass | planned                | not validated         | Governed or planned only; no current product availability is claimed.                                                                                   |
