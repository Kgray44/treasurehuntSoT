...
[Installation](administrator/installation.md), [configuration](administrator/configuration.md), [self-hosting](administrator/self-hosting.md), [deployment](administrator/deployment.md), [backup and recovery](administrator/backup-and-recovery.md), [private content](administrator/private-content.md), and [upgrading](administrator/upgrading.md).
