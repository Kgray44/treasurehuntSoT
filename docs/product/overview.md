...
Published versions are immutable for a stable player experience. Privacy and consent are core: public projections expose only intentionally shareable information, while private content uses protected workflows. See [features](features.md) and [terminology](terminology.md).
