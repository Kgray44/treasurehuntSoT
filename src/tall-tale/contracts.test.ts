...
import { verificationSubmissionSchema } from "@/tall-tale/progression";
import { slugify, slugSchema, studioDraftSchema } from "@/tall-tale/studio-service";
...
describe("Tall Tale Studio contracts", () => {
