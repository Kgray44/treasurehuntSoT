...
import { createInstallPlan, beginInstallOperation, commitInstallOperation, compareReleaseUpdate } from "./exchange";
...
describe("Community installation", () => {
  ...
  it("protects stale destinations and local edits from linked overwrite", () => {
    ...
    expect(() => createInstallPlan({ ...input, mode: "LINKED", localModificationChecksum: "changed" })).toThrow(
      "Local edits",
    );
  });
