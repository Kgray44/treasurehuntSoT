...
describe("Community social interaction contracts", () => {
  ...
  it("never returns review spoiler bodies from the default public projection", () => {
    const projection = publicReviewProjection({ id: "review-1", listingId: "listing-1", rating: 5, spoilerFreeBody: "Safe body", spoilerBody: "Hidden finale", spoilerLevel: "SPOILER", verifiedInstallation: true, verifiedCompletion: false, status: "ACTIVE", editedAt: null, deletedAt: null });
  ...
  it("never returns comment spoiler bodies from the default public projection", () => {
    const projection = publicCommentProjection({ id: "comment-1", subjectType: "GUIDE", subjectId: "guide-1", parentCommentId: null, depth: 0, body: "Safe", spoilerBody: "Hidden", spoilerLevel: "SPOILER", status: "ACTIVE", editedAt: null, deletedAt: null, createdAt: new Date("2026-07-25") });
