...
import { parseJsonArray, parseJsonObject } from "@/chronicle/types";
...
export async function startTaleSession(slug: string, ownerLabel?: string) {
  ...
  logger.info(
    { area: "chronicle-session", sessionId: created.session.id, taleId: tale.id, versionId: version.id },
