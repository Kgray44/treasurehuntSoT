...
const requested = (process.env.HOMEPORT_PHASE7_CORRECTION_JOURNEYS ?? "ABCDEFGHIJKLMNOPQRSTU").replaceAll(
  /[^A-U]/gu,
  "",
);
...
run("scripts/homeport/phase7-owner-correction-round1-database-clone.mjs", ["journeys"], {
  ...process.env,
...
process.stdout.write(
  `${JSON.stringify({ status: "HOMEPORT_PHASE7_OWNER_CORRECTION_ROUND1_JOURNEYS_PASSED", journeys: [...requested] })}\n`,
);
