...
const target = resolve(
  process.cwd(),
  "Development_Docs/Projects/Project Drydock/Project_Drydock_Phase_2_Rule_Catalog.json",
);
const document = {
  schemaVersion: 1,
  catalogVersion: 1,
  ...
  scope:
    "Executable Drydock rules currently emitted by implemented Phase 1 and Phase 2 validation; this record does not claim complete Phase 2 coverage.",
