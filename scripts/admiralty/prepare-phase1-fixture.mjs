...
// Prisma 6 on Windows needs the SQLite target to exist before migrate deploy can open it.
await writeFile(databasePath, "", "utf8");
const password = `Adm1-${randomBytes(24).toString("base64url")}!`;
const env = {
  ...process.env,
  ADMIRALTY_PHASE1_TASK_ROOT: taskRoot,
  ADMIRALTY_PHASE1_SYNTHETIC_PASSWORD: password,
...
const fixture = runJson("scripts/admiralty/seed-phase1-fixture.mjs", env);
const receipt = {
  status: "ADMIRALTY_PHASE1_FIXTURE_READY",
