...
export const projectRegistry: readonly ProjectRecord[] = [
  record(
    ...
    "Project Bridgewatch",
    "COMPLETE",
    "Development_Docs/Programs/Bridgewatch/Project_Bridgewatch_Completion_Receipt.md",
    [
      phase(
        "bridgewatch",
        1,
        "Raise the Board",
        "MERGED",
        "Development_Docs/Programs/Bridgewatch/Project_Bridgewatch_Phase_1_Design_Record.md",
        {
      ...
      phase(
        ...
        "Wire the Signals",
        "COMPLETE",
        "Development_Docs/Programs/Bridgewatch/Project_Bridgewatch_Phase_2_Design_Record.md",
        {
          ...
          completionReceipt: "Development_Docs/Programs/Bridgewatch/Project_Bridgewatch_Phase_2_Completion_Receipt.md",
      ...
      phase(
        ...
        "Keep the Watch",
        "COMPLETE",
        "Development_Docs/Programs/Bridgewatch/Project_Bridgewatch_Phase_3_Design_Record.md",
        {
          ...
          finalDecision: "RELEASE_GO",
          completionReceipt: "Development_Docs/Programs/Bridgewatch/Project_Bridgewatch_Phase_3_Completion_Receipt.md",
    ...
    {
      completionReceipt: "Development_Docs/Programs/Bridgewatch/Project_Bridgewatch_Completion_Receipt.md",
  ...
  record(
    ...
    [
      ...
      phase(
        ...
        "Open the Chartroom",
        "ACTIVE",
        "Development_Docs/Projects/Project_Admiralty/Project_Admiralty_Platform_Administration_and_Operations_Governing_Document_v1.2.pdf",
      ),
    ],
  ),
  record(
  ...
  record(
    ...
    "Project True North",
    "UNKNOWN",
    "Development_Docs/Programs/True_North/Project_True_North_Completion_Receipt.md",
    [
      phase(
        "true-north",
        1,
