...
CREATE TABLE `CommunityPackageDependency` (
  ...
  PRIMARY KEY (`id`), UNIQUE INDEX `CommunityPackageDependency_package_logical_key` (`packageId`,`dependentLogicalId`,`requiredLogicalId`), INDEX `CommunityPackageDependency_packageId_idx` (`packageId`),
