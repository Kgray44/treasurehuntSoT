...
const databasePath = path.resolve(required("TIDEGLASS_PHASE3_DATABASE_PATH"));
const port = Number.parseInt(process.env.TIDEGLASS_PHASE3_PORT ?? "3793", 10);
...
const env = {
  ...
  VOYAGEWRIGHT_BUILD_SHA: required("TIDEGLASS_PHASE3_SOURCE_SHA"),
};

export default defineConfig({
  testDir: "./tests/e2e",
  testMatch: /tideglass-phase3\.spec\.ts/u,
  timeout: 180_000,
