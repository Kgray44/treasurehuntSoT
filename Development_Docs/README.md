...
This archive preserves governing documents, decisions, program records, validation evidence, migrations, completion receipts, and superseded historical artifacts. It is not end-user documentation.
...
protected PR #10, and the trusted public-origin correction is integrated through
protected PR #12. The owner accepted successful real Google and GitHub sign-in
...
[Project Tideglass](Projects/Project_Tideglass/README.md) owns deterministic semantic comparison of exact immutable Chronicle editions. Phases 1-3 are accepted mainline semantic authority. Phase 3 adds ordinary comparison, owned-history, and Studio semantic-consumer journeys through protected PR #59 and exact-main Sounding Line evidence; deployment and production-provider claims remain separate.
