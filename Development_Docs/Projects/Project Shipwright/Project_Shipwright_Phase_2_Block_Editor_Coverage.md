...
| setVariable         | PURPOSE_BUILT      | Yes / Yes / Yes                 | Canonical registry / default edge summary          | — / contract / inline                                   | Search/filter variable browser, contract-permitted operations, typed operands, and confirmed Drydock rename propagation. |
