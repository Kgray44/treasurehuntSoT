...
| ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Reconciled source contract                                                               | PASS: `npm run tideglass:phase3:validate` on `4d7d7f5908e28275ed5e9b12d5addbe6973f9abb`                                                                                                                                | Non-authoritative source contract; confirms preserved policy versions, registered states, bounded return path, history adapter, and retired raw Studio comparator. |
