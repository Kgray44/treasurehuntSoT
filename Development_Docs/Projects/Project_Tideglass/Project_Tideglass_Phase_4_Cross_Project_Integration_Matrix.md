...
| Helm                    | Selected playable edition and owner-recommended edition context                 | Captain authority, Voyage creation, launch and live command              | Read-only Captain preflight implemented; exact public-or-own Chronicle pair, CAPTAIN_SAFE summary, no Voyage mutation |
