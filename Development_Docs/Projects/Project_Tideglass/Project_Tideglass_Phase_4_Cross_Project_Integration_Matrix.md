...
| Harborlight             | Same-Chronicle release transition context                                      | Package, lineage, install, rollback, licensing and visibility            | Current update input has no canonical edition pair; no consumer invented                    |
