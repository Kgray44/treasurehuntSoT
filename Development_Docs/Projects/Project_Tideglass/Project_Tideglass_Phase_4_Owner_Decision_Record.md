...
Automated browser evidence: local synthetic fixture
...
- `OWNER_ACCEPTED` — the owner accepts the observed Phase 4 product boundary.
- `OWNER_ACCEPTED_WITH_EXPLICIT_LIMITATIONS` — the owner accepts with written,
  bounded limitations.
