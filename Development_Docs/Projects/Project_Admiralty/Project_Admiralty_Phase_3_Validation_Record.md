...
| Phase 3 receipt schema                                  | Passing                 | Both SQLite and MySQL Prisma schemas validate with non-production placeholder URLs; paired additive migrations are reserved. |
