...
| `ae66412` through `3219fd1`                | Adjacent product, schema, and governance work   | Adds Tideglass Phase 2 edition intelligence, Creator annotations, additive dual-provider migrations, APIs, tests, records, and Sounding Line coverage, then integrates the accepted implementation through pull request 29. Helm-owned participation source did not conflict. |
| `174f0e8`, `fca5838`                       | Adjacent accepted-mainline record correction    | Finalizes Tideglass Phase 2 evidence, adds the missing FT-B009 catalog assertion, preserves the explicit Studio limitation, and integrates the correction through pull request 30. No Helm-owned product source changed.                                                      |
