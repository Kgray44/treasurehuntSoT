...
- [Windows command-length follow-up](Programs/Sounding_Line/Project_Sounding_Line_Windows_Command_Length_Follow_Up.md) records an open, documentation-only Windows process-launch limitation discovered during an ordinary Brightwork qualification. It authorizes no Sounding Line change.
