...
| Current Phase branch           | `codex/project-bridgewatch-phase3-keep-the-watch-5`   |
...
retained as historical evidence. This `-5` candidate must not edit the remaining
pending facts speculatively. It is updated only after its own frozen candidate
is bound to the current protected-main process and after a fresh post-merge
fetch proves the merged ancestry.
