...
| Acceptance                 | `tests/private-content/protected-media-*.test.ts`; `src/app/api/studio/private-content/media/route.test.ts`; `tests/e2e/sealed-hold-phase4.spec.ts`; `tests/config/playwright/playwright.sealed-hold-phase4.config.ts`         |
