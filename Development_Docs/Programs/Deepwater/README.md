...
The Phase 2 validation and integration records are added only when their corresponding checkpoints complete. The Phase 3 queue is planning input only; Phase 3 remediation is not authorized or active in this worktree.
