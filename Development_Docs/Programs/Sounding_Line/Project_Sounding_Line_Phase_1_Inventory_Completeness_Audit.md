...
Historical Phase 1 debt was superseded by Phase 2 reconciliation. Current debt is `debt.historical-timing` and `debt.external-provider-evidence`; neither permits release narrowing.
