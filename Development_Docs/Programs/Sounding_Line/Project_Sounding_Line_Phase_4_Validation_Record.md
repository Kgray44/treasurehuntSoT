...
| Targeted browser/concurrency                 | PASS: Harborlight lanes A/B, 2/2 browser tests each |
...
P34 remains non-green and no complete browser matrix was rerun. The targeted
lane receipt is retained under the marker-owned local validation root
`sounding-line-phase4-20260729/logs/harborlight-browser-lanes.json`. Hosted CI,
