...
| Reconciled accepted-main base   | `f07fbb693e32f6b1069870fae9da668ed3392d4b`                               |
...
| `browser.wakebook`                   | Task-owned SQLite clone, leased loopback port, isolated Chromium context | PASS / CLEAN, 1/1       | Source `e057cf9e`; synthetic browser    |
| `browser.community`                  | Task-owned SQLite clone; Chromium and WebKit Community families          | PASS / CLEAN, 10/10     | Source `e057cf9e`; shared-seam proof    |
...
1. Re-fetch `origin/main` immediately before the final evidence commit and reconcile any newly accepted source semantically.
