...
The owner draft/editor persists revisions, permitted text/participants/media, location precision, Creator restrictions and spoiler classification without mutating a One Voyage session, event, membership or Wayfarer private record. Publication is transactional and revalidates opaque source identity, watermark, source and public projection checksums, exact published version/completion, consent, public derivative checksum/CLEAN scan state, sharing restrictions and public location/metadata/index eligibility. PRIVATE is owner-only, CREW_ONLY uses canonical membership, UNLISTED is exact-link/noindex/nofollow/noarchive, and COMMUNITY is public only while fully eligible. Archived/removed/review-required records retain safe audit identity but no public content.
